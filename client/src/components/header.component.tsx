    ...
    return (
        <div className="header">
            <div className="menu">
                ...
                <button onClick={ () => setDialog('singIn') } className={`button blue ' ${dialog === 'singIn' ? 'open' : ''} `}>SignIn</button>
            </div>
            { dialog === 'login' && <div ref={wrapperRef} className="dialog login-area">
                <Login />
            </div> }
            { dialog === 'singIn' && <div ref={wrapperRef} className="dialog sign-in-area">
                <SignIn />
            </div> }
        </div>
    );
